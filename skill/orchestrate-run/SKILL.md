...
result, and a backgrounded suite or Monitor *does* wake them. Reserve **named
in-process teammates** for a builder you expect to steer mid-flight, and only with
