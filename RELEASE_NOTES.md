...
Haven now keeps a clearer audit trail for the decisions that move work up, down, in, or out of the active backlog. Priority changes, fine ordering, and commitment changes can carry a rationale, and agents get better guidance when they need to fetch several item details at once.
...
- No migration is required. The new provenance events use Haven's existing lineage model.
